...
//		intent.putExtra("STACKTRACE", report);
		...
		String filePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/ErrorDiscription/" + "errorTrace.txt";
		// sendErrorMail(CrashActivity.this);
		
		Mail m = new Mail("yourMailId@gmail.com", "yourMailPassword");
		
		String[] toArr = { "Whome you want to send mail enter their mail ids here" };
		m.setTo(toArr);
		m.setFrom("yourMailId@gmail.com");
		m.setSubject("This is an email sent using my Mail JavaMail wrapper from an Android device.");
		m.setBody("Will Solve This Issue Soon,Thanks For Using.");
